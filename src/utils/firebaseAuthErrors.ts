...
export const firebaseAuthErrors: FirebaseErrorInterface = {
  "auth/wrong-password":
  ...
  "auth/missing-password": "A valid password is required.",
  ...
  "auth/invalid-credential": "Wrong or expired email or password.",
